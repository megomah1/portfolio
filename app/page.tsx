  ...
  return (
    <>
      <section className="mx-auto grid max-w-5xl grid-cols-1 items-center gap-12 px-6 py-20 sm:py-28 lg:grid-cols-[3fr_2fr]">
        <div>
          <p className="text-xl leading-relaxed text-zinc-600 sm:text-2xl dark:text-zinc-300">
        ...
        <div className="relative mx-auto w-full max-w-xs">
          <p className="mb-3 text-right text-sm italic text-zinc-500 dark:text-zinc-400">
            Select to learn more about me
          </p>
          <div className="rotate-2 rounded-md border border-zinc-200 bg-white p-3 pb-6 shadow-md transition-transform hover:rotate-0 dark:border-zinc-800 dark:bg-zinc-950">
